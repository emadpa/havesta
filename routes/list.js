...
router.route("/:id")
      ...
      .put(isloggedin,isowner,validatelist,upload.single('list[image]'),wrapAsync(listscontroller.updatelist))
      .delete(isloggedin,isowner,wrapAsync(listscontroller.deletelist));

router.get("/:id/edit",isloggedin,isowner,wrapAsync(listscontroller.renderformforedit));
